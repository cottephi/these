        ...
        \subsection{Les Large Electron Multipliers (LEM)}\label{sec::LEM}
            ...
            \begin{table}
                ...
                \begin{tabular}{|l|c|c|}
                    ...
                    \hline
                \end{tabular}
                \caption{Caractéristiques des LEM communes aux deux modèles utilisés dans \gls{wa105}.\label{tab::lem_commun}}
            \end{table}
    ...
    \section{Préparation, caractérisation et test à l'IRFU}
        ...
        \subsection{Les mesures d’épaisseur des LEM}\label{sec::epaisseur}
            ...
            \subsubsection{Comparaison aux mesures faites par ELTOS}\label{sec::thickness_comparison_eltos}
                ...
                \begin{wrapfigure}{r}{0.4\textwidth}
                    \includegraphics[width=0.4\textwidth]{eltos_measurement.png}
                    \caption{Gerber d'un \gls{lem} avec indiquées en rouges les zones où le fabricant a effectué les mesures pour vérifier la concordance au cahier des charges présenté en \autoref{sec::LEM}}
