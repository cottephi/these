    ...
    \section{Préparation, caractérisation et test à l'IRFU}
        ...
        \subsection{Les mesures d’épaisseur des LEM}\label{sec::epaisseur}
            ...
            \subsubsection{Résultats}
                ...
                \begin{figure}[htpb]
                    \begin{subfigure}[t]{0.48\textwidth}
                        ...
                        \caption{Distribution de l'épaisseur de totale moyenne d'un \gls{lem} pour tous les \glspl{lem} de la production de \gls{cea}.}
                        \label{fig::distri_lem_saclay}
                    \end{subfigure}
                    \hfill
                    \begin{subfigure}[t]{0.48\textwidth}
                        \includegraphics[width=\textwidth,keepaspectratio]{Copper_means_sum_all_histo_saclay.png}
                        \caption{Distribution de l'épaisseur de cuivre moyenne d'un \gls{lem} pour tous les \glspl{lem} de la production de \gls{cea}.}
                ...
                \end{wrapfigure}
                Les distributions des hauteurs dans les 25 trous de mesure du \gls{lem} sont tracées avec correction pour la pente du marbre. La \autoref{fig::distri_1_trou_lem} montre une telle distribution pour un trou de mesure. Une double gaussienne y est ajustée afin de déterminer l'épaisseur totale $E_T$ du \gls{lem} ainsi que l'épaisseur $E_C$ du cuivre. Le pic le plus à droite sur la \autoref{fig::distri_1_trou_lem} correspond à l'épaisseur totale $E_T$ du \gls{lem}, tandis que le pic le plus à gauche correspond à $E_T - E_C$, en supposant que l'épaisseur du cuivre est la même sur chaque face. $E_C$ est alors calculable facilement, de même que l'épaisseur de \gls{fr4} $E_F$ car nous avons la relation $E_T = E_F + 2E_C$.
                ...
                La \autoref{fig::epaisseur_tous_lem} montre la distributions des épaisseurs totales et des épaisseurs de cuivre pour tous les \glspl{lem} mesurés.
            ...
            \subsubsection{Comparaison aux mesures faites par ELTOS}\label{sec::thickness_comparison_eltos}
                ...
                La \autoref{fig::mesures_eltos} montre les zones du \gls{lem} où ELTOS a mesuré les différents paramètres importants : la taille totale, l'épaisseur totale, l'épaisseur de cuivre, l'épaisseur de \gls{fr4}, l'épaisseur des rims et la taille des trous. Le \autoref{tab::mesures_eltos} résume les résultats obtenus et le \autoref{tab::thickness_comparison_eltos} compare les résultats des épaisseurs totale et de cuivre à ceux obtenus à Saclay.
                
                \begin{table}
                \centering
                \begin{tabular}{|l|c|c||c|c|}
                    \hline
                    \gls{cea} & Moyenne & Écart type & Moyenne \gls{cci} & Écart type \gls{cci}\\
                    \hline
                ...
                \begin{tabular}{|l|c|c||c|c|}
                    \hline
                    \gls{cern} & Moyenne & Écart type & Moyenne \gls{cci} & Écart type \gls{cci}\\
                    \hline
                    Épaisseur d'époxy & \SI{0.97}{\milli\meter} & \SI{0.01}{\milli\meter} & &\\
            ...
            \end{table}
                ...
                %TODO Comparaison à Eltos et discussion.
