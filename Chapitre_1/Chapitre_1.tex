...
\chapter{La physique des neutrinos}
   ...
   %RAJOUTER UN PETIT MOT SUR CC et NC
...
%RAJOUTER ENCADRE SUR U(1)? Ou faire une annexe?
  ...
  \section{Le paradigme des oscillations des neutrinos}
    ...
    \subsection{Courant chargé et courant neutre}\label{sec::courants}
      
      %TODO
      Avant de se lancer dans l'oscillation des neutrinos à proprement parler, il est nécessaire de présenter les différents modes d'interactions des neutrinos avec la matière. \textcolor{red}{à faire}.
    ...
    \subsection{La matrice PMNS}\label{sec::pmns}
      ...
      \subsubsection{Développement limité de la matrice PMNS, ordre de masse et terme de violation de CP}
        ...
        \end{equation}
        où $A_{atm} = \sin(\theta_{23})\sin(2\theta_{13})\sin\left(\Delta m^2_{31}\frac{L}{4E}\right)$ et $A_{sol} =\cos(\theta_{23})\sin(2\theta_{12})\sin\left(\Delta m^2_{21}\frac{L}{4E}\right)$. Le dernier terme sera sensible à la phase de violation de CP. L'effet de ce terme sur la probabilité de transition est montré à la \autoref{fig::3flav_oscillation_cp}. \textcolor{red}{rajouter ordre de masse}
  ...
  \section{Les effets de matières}\label{sec::matter_effect}
    ...
    \subsection{Le cas à deux saveurs : illustration de l'effet Mikheyev-Smirnov-Wolfenstein}
      ...
      \subsubsection{L'effet de résonance Mikheyev-Smirnov-Wolfenstein}
        ...
        \begin{figure}[htpb][
          \centering
          \includegraphics[width=0.7\textwidth,keepaspectratio]{msw_ne.png}
    ...
    \subsection{Le cas à trois saveurs}\label{sec::3flavor_matter}
      ...
      \begin{figure}[htpb]
        ...
        \begin{subfigure}{\textwidth}
          \centering
          \includegraphics[width=0.6\textwidth]{3flav_oscillation.png}
          \caption{\label{fig::3flav_oscillation_vanilla}Oscillation de la probabilité de transition à trois saveurs de $P(\nu_{\mu}\to\nu_e)$ en fonction de $L/E$ sans effet de matière et avec $\delta_{CP}=0$. La courbe grise représente le terme principale prenant en compte $\Delta m^2_{31}$ dans l'équation \eqref{eq::dvpt_3flavor_accelerator}. La courbe verte représente le terme principale prenant en compte $\Delta m^2_{21}$. La courbe noire prend en compte tous les termes.}
        \end{subfigure}\\
        \begin{subfigure}{\textwidth}
          \centering
          \includegraphics[width=0.6\textwidth]{3flav_oscillation_cp.png}
        ...
        \begin{subfigure}{\textwidth}
          \centering
          \includegraphics[width=0.6\textwidth]{3flav_oscillation_matter.png}
          \caption{\label{fig::3flav_oscillation_matter}Effet de la matière sur la probabilité de transition $P(\nu_{\mu}\to\nu_e)$ en fonction de $L/E$. La courbe en rouge considère l'ordre de masse inversé.}
        \end{subfigure}\\
        \caption{\label{fig::3flav_oscillation}Probabilité de transition $P(\nu_{\mu}\to\nu_e)$ en fonction de $L/E$ à une ligne de base de \SI{3000}{\kilo\meter}. les graphs viennent de l'étude de Bass et.al présentée au chapitre suivant\cite{Bass2013}.}
      \end{figure}
...
%	            Si il existe plus de 3 saveurs de neutrinos pouvant se mélanger, alors la matrice PMNS ne devrait pas être unitaire. C'est en testant cette unitarité que l'on peut déterminer la dimension de la matrice. Un article de 2018\cite{Qian2013} décrit comment réaliser un tel test, qui requière plus de données que ce que l'on a actuellement pour donner un résultat précis. Pour le moment, les données sont compatibles avec une matrice PMNS à trois dimensions unitaire, et pose une limite sur les couplages avec un possible quatrième neutrino.
      ...
      \subsubsection{L'ordre des masses}
