...
%                        \\ \SI{720}{\kilo\tonne\mega\watt\year}
    ...
    \begin{frame}{Les 4 modules du détecteur lointain}
        \includegraphics[width=\textwidth]{FD_full.png}
%        \begin{scriptsize}
...
%                    \textbf{Premier module (SP)} : 2024.\\
%                    \textbf{Second module (DP)} : 2025.\\
%                    \textbf{Premières données} : 2026\\
%                    \textbf{Troisième module (SP)} : 2027\\\vspace{0.4cm}
...
%           	\item Signal/Bruit : $\sim$ 10 pour une MIP
    ...
    \begin{frame}{Le démonstrateur de \SSS{}}
    	\begin{scriptsize}
                \centering
    			\vspace{-0.45cm}\includegraphics[width=\textwidth]{666_full.png}\\
    			\vfill
    ...
    \begin{frame}{Test de continuité des anodes}
        \begin{scriptsize}
            \includegraphics[width=\textwidth]{anode_cards_2.png}
            \begin{columns}
                \begin{column}{0.65\textwidth}
...
%    		\textbf{$\Rightarrow$ Use CFR-35 for $\mathbf{6 \boldsymbol{\times} 6 \boldsymbol{\times} \SI[detect-weight]{6}{\meter\cubed}}$}.\\
    ...
    
    {
        \begin{specialframe}
           ...
           \multicolumn{1}{|l|}{DU$\nu$E} & \begin{tabular}[c]{@{}l@{}}+ \\ ($5\sigma$ $50\,\%$ $\delta_{CP}$, \SI{10}{\year})\end{tabular} & \begin{tabular}[c]{@{}l@{}}+++ \\ ($5\sigma$ $\forall\delta_{CP}$, \SI{2}{\year})\end{tabular} & \SI{1300}{\kilo\meter} & 2 \\
           \multicolumn{1}{|l|}{T2HK} & ++ &  & \SI{295}{\kilo\meter} & 1 \\
           \multicolumn{1}{|l|}{T2HKK} & +++ & + & \SI{295}{\kilo\meter} et  \SI{1100}{\kilo\meter} & 2 \\
           \multicolumn{1}{|l|}{ESS$\nu$SB} & \begin{tabular}[c]{@{}l@{}}+++\\ ($5\sigma$ $60\,\%$ $\delta_{CP}$, \SI{10}{\year})\end{tabular} &  & \SI{540}{\kilo\meter} & 2nd \\ \hline
           \end{tabular}
            \begin{scriptsize}
