        ...
        \subsection{Les mesures d’épaisseur des LEM}\label{sec::epaisseur}
            ...
            \subsubsection{Motivation : impact sur le gain}
                ...
                \begin{figure}[htbp]
                    ...
                    \hfill
                    \begin{subfigure}[t]{0.48\textwidth}
                        \includegraphics[width=\textwidth,keepaspectratio]{thickness_influence_on_gain_zoom_3.5k.pdf}
                        \caption{Influence de l'épaisseur d'un \gls{lem} sur le gain, agrandissement autour de \SI{35}{\kilo\volt\per\centi\meter}.}
                    \end{subfigure}
                    \caption[Influence de l'épaisseur d'un \gls{lem} sur le gain.]{Influence attendue de l'épaisseur d'un \gls{lem} sur le gain, d'après le formule \eqref{eq::townsend_avalanche_2} ajustée aux données de la chambre haute pression de Saclay. La référence d'épaisseur pour calculer les pourcentages est \SI{1}{\milli\meter}.}
