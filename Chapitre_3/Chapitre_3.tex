        ...
        \subsection{Les Large Electron Multipliers (LEM)}\label{sec::LEM}
            ...
            \begin{figure}[htbp]
                \begin{subfigure}[b]{0.5\textwidth}
                    \begin{center}\includegraphics[width=\textwidth,keepaspectratio]{Chapitre_3/pictures/LEM.JPG}\end{center}
                    \caption[Photo d'un \gls{lem} de présérie du modèle CFR-34.]{Photo d'un \gls{lem} de présérie du modèle CFR-34.}
                \end{subfigure}
                \begin{subfigure}[b]{0.5\textwidth}
                    \begin{subfigure}[b]{\textwidth}
                        \begin{center}\includegraphics[width=\textwidth,keepaspectratio]{Chapitre_3/pictures/LEM_honeycomb1.JPG}\end{center}
                        \caption[Photo de la disposition en nid d'abeille des trous d'un \gls{lem}.]{Photo de la disposition en nid d'abeille des trous d'un \gls{lem}.}
                    \end{subfigure}
                    \begin{subfigure}[b]{\textwidth}
                        \begin{center}\includegraphics[width=\textwidth,keepaspectratio]{Chapitre_3/pictures/LEM_honeycomb2_annotations.png}\end{center}
                        \caption[Agrandissement de la disposition en nid d'abeille des trous d'un \gls{lem}.]{Agrandissement de la disposition en nid d'abeille des trous d'un \gls{lem}.}
                    \end{subfigure}
                \end{subfigure}
                \caption{Photos d'un \gls{lem}.}
                \label{fig::LEM}
            \end{figure}
