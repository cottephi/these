...
%      \end{itemize}
    ...
    \subsection{Le prototype de \TOO{}}\label{sec::TOO-intro}
      ...
      Le \TOO{} (\autoref{fig::311}), construit et exploité entre 2016 et 2017, avait deux objectifs principaux :
      \begin{itemize}
      ...
      Tous les détails techniques présentés ici sont tirés de \cite{Aimard2018}. Les dimensions extérieures du \TOO{} sont de $\numprint{7.3}\times\numprint{4.7}\times\SI{4.8}{\meter\cubed}$. Le volume interne du cryostat
    ...
    \subsection{De l'ionisation de l'argon à la dérive des électrons}\label{sec::ionisation}
      ...
      \subsubsection{Énergie déposée dans l'argon liquide}
        ...
        \begin{figure}[!htb]
          ...
          \caption[Distribution de Landau-Vavilov convoluée à une gaussienne]{\label{fig::langau}Exemple de distribution de Landau-Vavilov (pointillés noirs) convoluée à une gaussienne (trait plein bleu). Les traits verticaux indiquent les valeurs les plus probables des deux distributions.}
        \end{figure}
