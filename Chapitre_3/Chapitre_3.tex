        ...
        \subsection{Les mesures d’épaisseur des LEM}\label{sec::epaisseur}
            ...
            \subsubsection{Méthode expérimentale}
                ...
                \paragraph{Aplanir le LEM}
                    ...
                    \begin{wrapfigure}{r}{0.4\textwidth}
                        \includegraphics[width=0.4\textwidth,keepaspectratio]{plate_and_bricks.JPG}
                        \caption[Système servant à applanir le \gls{lem} sur le marbre.]{Système servant à applanir le \gls{lem} sur le marbre.}
                ...
                \paragraph{Calibrations et mesures}
                    ...
                    \begin{wrapfigure}{r}{0.4\textwidth}
                        \includegraphics[width=0.4\textwidth,keepaspectratio]{marbre.png}
