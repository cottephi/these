        ...
        \begin{scriptsize}
            ...
            \begin{columns}
                \begin{column}{0.5\textwidth}
                    \begin{itemize}
                        \item Expérience d'\textbf{oscillation des neutrinos} d'accélérateur à longue ligne de base au USA, prévue pour fin 2026
            ...
            \begin{columns}
                ...
                \begin{column}{0.4\textwidth}
                    \begin{itemize}
                        ...
                        \item Plusieurs théories dépendent de \textcolor{red}{l'ordre des masses} des neutrinos.
    	...
    	\begin{scriptsize}
    			...
    			\begin{minipage}{0.32\textwidth}
    				\begin{itemize}
    					...
    					\item \textcolor{red}{Stabilité sur de très longues périodes (DU$\nu$E $\sim$ 20 ans)}
    				\end{itemize}
    			\end{minipage}\hfill
    			\begin{minipage}{0.32\textwidth}
    				\begin{itemize}
