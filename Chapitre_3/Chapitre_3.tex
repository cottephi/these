    ...
    \section{Introduction technique}
        ...
        \subsection{Rôle du CRP}\label{sec::crp_intro}
            ...
            \begin{figure}[htbp]
                ...
                \end{subfigure}
                \begin{subfigure}[b]{\textwidth}
                    \begin{center}\includegraphics[width=\textwidth,keepaspectratio]{Chapitre_3/pictures/crp_666_complete.png}\end{center}
        ...
        \subsection{Les Large Electron Multipliers (LEM)}\label{sec::LEM}
            ...
            \begin{figure}[htbp]
                \begin{center}\includegraphics[width=\textwidth,keepaspectratio]{Chapitre_3/pictures/LEM_zoom.png}\end{center}
            ...
            \begin{figure}[htbp]
                \begin{subfigure}[t]{0.48\textwidth}
                    \includegraphics[width=\textwidth,keepaspectratio]{Chapitre_3/pictures/CFR-34.png}
                ...
                \hfill
                \begin{subfigure}[t]{0.48\textwidth}
                    \includegraphics[width=\textwidth,keepaspectratio]{Chapitre_3/pictures/CFR-35.png}
    ...
    \section{Les zones mortes des LEM}\label{sec::zones_mortes}
        ...
        \subsection{Méthode de simulation}
            ...
            \subsubsection{Carte de champ avec ANSYS}
                ...
                \begin{figure}[htbp]
                    \begin{subfigure}[t]{0.48\textwidth}
                        \includegraphics[width=\textwidth,keepaspectratio]{lem_border_annotations.png}
